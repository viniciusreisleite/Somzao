...
ACCOUNTS = [
    {"username": "loja_somzao", "badge": "Loja & Som", "color": "#e11d48"},
    {"username": "estetica_somzao", "badge": "Estética Automotiva", "color": "#0284c7"}
]
...
def processar_mural():
    ...
    print("=== INICIANDO SINCRONIZAÇÃO SOMZÃO (SESSÃO AUTENTICADA) ===")
    ...
    with sync_playwright() as p:
        ...
        if cookies_playwright:
            ...
            print(f"Sessão ativada: {len(cookies_playwright)} cookies carregados.")
        ...
        for acc in ACCOUNTS:
            ...
            print(f"Posts no feed de @{usr}: {len(candidatos)} identificados.")
